    ...
    <div class="p-0 card-body d-flex flex-column justify-content-center">
      ...
      <div class="mt-1 mx-2" v-show="cropImg">
        <div class="form-group" >
          ...
          <div class="text-end">
						<ButtonTemplate @click="drawHeadline1" class="mt-1">合成</ButtonTemplate>
          </div>
        </div>
        ...
        <div class="form-group mt-1">
          ...
          <div class="text-end">
						<ButtonTemplate @click="drawDetail1" class="mt-1">合成</ButtonTemplate>
          </div> 
        </div>
        <div class="form-group">
          ...
          <div class="text-end">
						<ButtonTemplate @click="drawDetail2" class="mt-1">合成</ButtonTemplate>
          </div> 
        </div>
				<div class="form-group">
          ...
          <div class="text-end">
						<ButtonTemplate @click="drawDetail3" class="mt-1">合成</ButtonTemplate>
          </div> 
        </div>
      </div>
      <div class="mt-2">
