    ...
    // END: Video player
		...
		darkMode: function () {
			...
			var changeThemeToDark = () => {
				...
				if(dir == 'rtl') {
						style.setAttribute('href', '/bootstrap_themes/assets/css/style-dark-rtl.css');
				} else {
						style.setAttribute('href', '/bootstrap_themes/assets/css/style-dark.css');
				}
			...
			var changeThemeToLight = () => {
				...
				if(dir == 'rtl') {
						style.setAttribute('href', '/bootstrap_themes/assets/css/style-rtl.css');
				} else {
						style.setAttribute('href', '/bootstrap_themes/assets/css/style.css');
				}
	...
	avatarImg: function () {
		if (e.isVariableDefined(e.select('#avatarUpload'))) {
			...
			avtReset.addEventListener("click", function(){
				avtPreview.src = "/bootstrap_themes/assets/images/avatar/placeholder.jpg";
			});
		}			
	},
	// END: Avatar Image
